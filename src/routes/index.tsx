...
function TrustStrip() {
  ...
  return (
    <section className="border-y border-border bg-surface">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 px-4 py-10 sm:grid-cols-2 sm:px-6 lg:px-8 items-stretch">
        {stats.map((s) => (
...
function WhyUs() {
  const items = [
    ...
    { icon: ShieldCheck, title: "Track Every Invoice With Ease", body: "Track paid and outstanding invoices without the hassle." },
  ];
  return (
